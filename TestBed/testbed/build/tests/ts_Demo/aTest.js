System.register(["@box2d", "@testbed", "./simul/object/ObjectFactory.js"], function (exports_1, context_1) {
    "use strict";
    var Box2D, testbed, ObjectFactory_js_1, PingPongTest, testIndex;
    ...
    return {
        ...
        execute: function () {
            PingPongTest = class PingPongTest extends testbed.Test {
                constructor() {
                    super();
                ...
                static Create() {
                    return new PingPongTest();
                }
            };
            exports_1("PingPongTest", PingPongTest);
            exports_1("testIndex", testIndex = testbed.RegisterTest("PingPong", "demoTest", PingPongTest.Create));
        }
    };
});
