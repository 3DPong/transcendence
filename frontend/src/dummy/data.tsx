...
export const dummy_chatdata: Message[][] = [
  [
    ...
    { id: 8, senderId: 4, content: '테스트메시지입니다', created_at: '2022-03-12 15:27:45' },
    {
      ...
      senderId: 4,
      content:
        '또 테스트 메시지 아주길게 작성하면 어떻게될까요? 정말 궁금하네요또 테스트 메시지 아주길게 작성하면 어떻게될까요? 정말 궁금하네요또 테스트 메시지 아주길게 작성하면 어떻게될까요? 정말 궁금하네요',
      created_at: '2022-03-12 16:27:45',
    },
...
export const dummy_users: ChatUser[] = [
  {
    id: 1,
    profile: 'https://cdn.intra.42.fr/users/438c44cacfdc69822c7ff066a0b7959d/dongkim.jpg',
    nickname: 'dongkim',
    role: 'owner',
    status: 'online',
  },
  {
    id: 2,
    profile: 'https://cdn.intra.42.fr/users/3185bf6f53751f455e9b1f5833c23393/minkyeki.JPG',
    nickname: 'minkyeki',
    role: 'admin',
    status: 'online',
  },
  {
    id: 3,
    profile: 'https://cdn.intra.42.fr/users/e433fdfa3b130d737d084240f3e86371/sungjpar.jpg',
    nickname: 'sungjpar',
    role: 'user',
    status: 'offline',
  },
  {
    id: 4,
    profile: 'https://cdn.intra.42.fr/users/22068839dcdec3e543cf9dfdec1fcf8e/schoe.jpg',
    nickname: 'schoe',
    role: 'admin',
    status: 'ingame',
  },
  {
    id: 5,
    profile: 'https://cdn.intra.42.fr/users/60f2218ca091c4fdff3f596797747bc4/kbaek.jpg',
    nickname: 'kbaek',
    role: 'user',
    status: 'offline',
  },
  {
    id: 6,
    profile: 'https://cdn.intra.42.fr/users/60f2218ca091c4fdff3f596797747bc4/kbaek.jpg',
    nickname: 'testsetsetsetsetsetsetsetsetsetsetsetsetsetsetsnjak',
    role: 'user',
    status: 'offline',
  },
];
...
export const dummy_chatrooms: Channel[] = [
  ...
  },
  {
    id: 3,
    type: 'public',
    title: '1:1 PONG 초보만sanfjkasnfjkasnfjkasdnfjkasndfjkansfjka',
    owner: {
      id: 1,
      profile: 'https://cdn.intra.42.fr/users/438c44cacfdc69822c7ff066a0b7959d/dongkim.jpg',
      nickname: 'dongkim',
...
export const dummy_globalchatrooms: Channel[] = [
  ...
  },
  {
    id: 14,
    type: 'protected',
    title: '아주긴이름의 채팅방입니다 과연글이 어떻게될지 테스트하는 용도예요',
    owner: {
      id: 3,
      profile: 'https://cdn.intra.42.fr/users/e433fdfa3b130d737d084240f3e86371/sungjpar.jpg',
      nickname: 'sungjpar',
