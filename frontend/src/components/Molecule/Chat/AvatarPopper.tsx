              ...
              isTargetMuted ? (
                ...
                <MenuItem key={2} sx={menuItemStyles}>
                  ...
                  <div
                    ...
                    onClick={() => {
                      handleMuteClick(targetId, Number(muteTime));
                    }}
                  >
                    m Mute
                  </div>
              ...
              isTargetBanned ? (
                ...
                <MenuItem key={4} sx={menuItemStyles}>
                  ...
                  <div
                    style={{ paddingLeft: "2px" }}
                    onClick={() => {
                      handleBanClick(targetId, Number(banTime));
                    }}
                  >
                    m Ban
                  </div>
