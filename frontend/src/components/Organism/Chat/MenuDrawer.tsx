    ...
    <>
      ...
      >
        <div className="flex flex-col w-full h-full">
          ...
          >
            {settingOpen ? (
              <ChannelSetting handleClose={() => setSettingOpen(false)} channel={channel} />
            ) : (
              <>
      ...
      {open && <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-40" onClick={handleClose} />}
    </>
  );
};
