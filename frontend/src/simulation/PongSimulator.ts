...
import { b2Object, b2Ground, b2Ball, b2Paddle, b2RandomPolygon } from '@/simulation/Objects';
...
export class PongSimulator
{
    ...
    constructor() {
        ...
        // Setup Ground
        this.m_Ground = new b2Ground(__box2dModule,
            {
        ...
        // Setup Ball
        this.m_Ball = new b2Ball(__box2dModule,
            {
                radius: 1,
                position: new b2Vec2(0, 0),
                Id: ObjectID.BALL,
        ...
        // Setup Paddle Left
        this.m_PaddleLeft = new b2Paddle(__box2dModule,
            {
        ...
        // Setup Paddle Right
        this.m_PaddleRight = new b2Paddle(__box2dModule,
            {
                position: new b2Vec2(+paddleOffset, 0),
                size: new b2Vec2(0.2, 2),
                jointControlPoint: new b2Vec2(+(arenaSize.width/2), 0),
