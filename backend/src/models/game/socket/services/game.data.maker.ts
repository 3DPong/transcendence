...
export class GameDataMaker {
  ...
  public makeObjectDatas(gameManager: GameManager): ObjectData[] {
  ...
  public makeRenderDatas(gameManager: GameManager): RenderData[] {
  ...
  public makeMatchResultData(gameManager: GameManager): MatchResultData {
    ...
    matchResult.leftScore = gameManager.player1.score;
    matchResult.rightScore = gameManager.player2.score;
    matchResult.winner =
      matchResult.leftScore > matchResult.rightScore ? matchResult.leftPlayerId : matchResult.rightPlayerId;
    return matchResult;
  }
}
